package com.potato.oneall.colleges;
...
public class AIITCollege implements College {
    public static final String NAME = "安徽信息工程学院";

    private static final String BASE_URL = "http://teach.aiit.edu.cn";
    private static final String SESS_URL = BASE_URL + "/xtgl/login_slogin.html?language=zh_CN&_t=1629025519106";
    private static final String LOGIN_URL = BASE_URL + "/xtgl/login_slogin.html?language=zh_CN&_t=1629025519106";
    private static final String RANDOM_CODE_URL = BASE_URL + "/xtgl/verifycode.servlet";
    private static final String INDEX_URL = BASE_URL + "/xtgl/index_initMenu.html";
    // 课程表json
    private static final String TIMETABLE_JSON_URL = BASE_URL + "/kbcx/xskbcx_cxXskbcxIndex.html?gnmkdm=N2151&layout=default";
    // 我的课表
    private static final String TERMS_URL = BASE_URL + "/kbcx/xskbcx_cxXskbcxIndex.html?gnmkdm=N2151&layout=default";
