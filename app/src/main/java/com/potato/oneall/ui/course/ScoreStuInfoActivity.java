...
public class ScoreStuInfoActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        DBHelper dbHelper = new DBHelper(ScoreStuInfoActivity.this);
        ...
        String url="https://223.247.140.116:35152/SelectStudentScore";
    ...
    private void initData(LinearLayout linearLayout){
        new Handler().postDelayed(() -> {
            for(int i=0; i<array.size(); i++){
                ...
                String studentName = "课程名：" + maps.get("name");
