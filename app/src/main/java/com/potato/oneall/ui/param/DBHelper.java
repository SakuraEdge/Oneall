...
public class DBHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        db.execSQL("create table login_info(id integer primary key autoincrement,name varchar(50),pwd varchar(50),post varchar(50),classname varchar(50))");
        ...
        db.execSQL("insert into login_info values(1,null,null,null,null)");
